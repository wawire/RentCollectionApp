...
namespace RentCollection.Infrastructure.Migrations
{
    ...
    [Migration("20260126113218_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.InspectionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MoveInCondition")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("MoveOutCondition")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("MoveOutInspectionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MoveOutInspectionId");

                    b.ToTable("InspectionItems", (string)null);
                });

            modelBuilder.Entity("RentCollection.Domain.Entities.InspectionPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.InvoiceLineItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("UtilityConfigId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.LandlordPaymentAccount", b =>
                {
                    ...
                    b.Property<string>("MPesaInitiatorName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("MPesaSecurityCredential")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.MeterReading", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.MoveOutInspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("SecurityDepositHeld")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("UnpaidRent")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("UnpaidUtilities")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("MoveOutInspections", (string)null);
                });

            modelBuilder.Entity("RentCollection.Domain.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.PaymentAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.UnmatchedPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ResolvedPaymentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("OtpLockoutUntil")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("LoginLockoutUntil");

                    b.HasIndex("MustChangePassword");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.UserPropertyAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "PropertyId", "AssignmentRole")
                        .IsUnique();

                    b.ToTable("UserPropertyAssignments");
                });

            modelBuilder.Entity("RentCollection.Domain.Entities.UtilityConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.UtilityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.InspectionItem", b =>
                {
                    b.HasOne("RentCollection.Domain.Entities.MoveOutInspection", "MoveOutInspection")
                        .WithMany("InspectionItems")
                        .HasForeignKey("MoveOutInspectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MoveOutInspection");
                });

            modelBuilder.Entity("RentCollection.Domain.Entities.InspectionPhoto", b =>
                {
                    b.HasOne("RentCollection.Domain.Entities.InspectionItem", "InspectionItem")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("RentCollection.Domain.Entities.Invoice", "Invoice")
                        .WithMany("LineItems")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentCollection.Domain.Entities.UtilityConfig", "UtilityConfig")
                        .WithMany()
                        .HasForeignKey("UtilityConfigId");

                    b.HasOne("RentCollection.Domain.Entities.UtilityType", "UtilityType")
                        .WithMany()
                        .HasForeignKey("UtilityTypeId");

                    b.Navigation("Invoice");

                    b.Navigation("UtilityConfig");
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.MeterReading", b =>
                {
                    b.HasOne("RentCollection.Domain.Entities.User", "RecordedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.MoveOutInspection", b =>
                {
                    b.HasOne("RentCollection.Domain.Entities.User", "InspectedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("RentCollection.Domain.Entities.Property", b =>
                {
                    ...
                    b.HasOne("RentCollection.Domain.Entities.Organization", "Organization")
                        .WithMany("Properties")
