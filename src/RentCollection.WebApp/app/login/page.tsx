...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Image */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <h1 className="text-5xl font-bold mb-6">RentPro</h1>
          <p className="text-2xl mb-4">Property Management Made Simple</p>
          <p className="text-lg opacity-90">
            Manage your rental properties, tenants, and payments all in one powerful platform.
          </p>
          <div className="mt-12 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg">Property Management</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-lg">Payment Tracking</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4 lg:hidden">
              <div className="text-4xl font-bold text-blue-600">RentPro</div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="admin@rentcollection.com"
              />
            </div>
