...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Image */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 to-teal-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <h1 className="text-5xl font-bold mb-6">Join RentPro</h1>
          <p className="text-2xl mb-4">Start Managing Your Properties Today</p>
          <p className="text-lg opacity-90">
            Create your account and get access to powerful property management tools.
          </p>
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4 lg:hidden">
              <div className="text-4xl font-bold text-green-600">RentPro</div>
            </div>
            <h2 className="text-3xl font-bold text-gray-900">Create Account</h2>
            <p className="text-gray-600 mt-2">Sign up to start managing your properties</p>
          </div>
